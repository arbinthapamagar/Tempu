...
SYSTEM = (
    ...
    "- NEVER wait to be asked for images. A complete answer to 'how do I…' shows "
    "the screens as it explains them. If ANY listed source has a screenshot that "
    "illustrates a step you are describing, include it — even when most of your "
    "wording comes from a different source that has none. Having to follow up with "
    "'any images?' means the first answer was incomplete.\n"
