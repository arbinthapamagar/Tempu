            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-[11px] uppercase tracking-wide text-gray-400 border-b border-gray-100">
                  ...
                  <th className="px-2 py-2.5 font-medium">URL</th>
                  <th className="px-2 py-2.5 font-medium text-right">Time</th>
                </tr>
              </thead>
              <tbody>
                {logs.map((log) => (
                  ...
                  >
                    <td className="px-4 py-2.5 text-gray-500 whitespace-nowrap" title={formatDateTime(log.createdAt)}>
                    ...
                    <td className={cn('px-2 py-2.5 font-semibold tabular-nums', statusColor(log.statusCode))}>
                      {log.statusCode}
                    </td>
                    <td className="px-2 py-2.5 text-gray-600">{log.domain}</td>
                    <td className="px-2 py-2.5 text-gray-800 font-mono text-xs max-w-[340px] truncate" title={log.url}>
                      {log.url}
                    </td>
                    <td className="px-2 py-2.5 text-right text-gray-400 tabular-nums whitespace-nowrap">{log.durationMs}ms</td>
                  </tr>
                ))}
              </tbody>
            </table>
