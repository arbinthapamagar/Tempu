...
// Multi-turn chat panel: conversation history, a "New chat" button to start
// fresh, suggestion chips, streamed-in markdown replies, and optional image
// attachment. `sendFn(text, history, image)` posts to the agentic endpoint.
// Only the last N turns are persisted — plenty for continuity across a refresh
// without letting localStorage grow unbounded over weeks of use.
